...
namespace Microsoft.AspNet.DataProtection.KeyManagement
{
    ...
    internal sealed class DefaultKeyResolver : IDefaultKeyResolver
    {
        ...
        private bool CanCreateAuthenticatedEncryptor(IKey key)
        {
            ...
            {
                _logger.KeyCreateEncryptorInstanceFailed(key.KeyId);
                return false;
            }
        }
        ...
        private IKey FindDefaultKey(DateTimeOffset now, IEnumerable<IKey> allKeys, out IKey fallbackKey, out bool callerShouldGenerateNewKey)
        {
            ...
            {
                _logger.ConsideringDefaultKey(preferredDefaultKey.KeyId, preferredDefaultKey.ExpirationDate);
                ...
                {
                    _logger.NotConsideringDefaultKey(preferredDefaultKey.KeyId);
            ...
            if (preferredDefaultKey != null)
            {
                ...
                {
                    _logger.DefaultKeyImminentAndRepositoryContainsNotSuccessor();
                }
