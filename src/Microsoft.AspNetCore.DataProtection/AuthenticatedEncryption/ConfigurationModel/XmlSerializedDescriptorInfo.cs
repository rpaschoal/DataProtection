...
namespace Microsoft.AspNetCore.DataProtection.AuthenticatedEncryption.ConfigurationModel
{
    ...
    /// <see cref="AlgorithmConfiguration"/> along with the type that can be used
    /// to deserialize it.
    /// </summary>
    public sealed class XmlSerializedDescriptorInfo
    {
        ...
        /// </summary>
        /// <param name="serializedDescriptorElement">The XML-serialized form of the <see cref="AlgorithmConfiguration"/>.</param>
        ...
        /// <summary>
        /// An XML-serialized representation of an <see cref="AlgorithmConfiguration"/>.
        /// </summary>
